...
func (h *HTTPHandler) GetProvision(c *gin.Context) {
	...
	prs, err := h.Service.GetProvision(id, typ, animal_type, quantity)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *HTTPHandler) GetAllProviison(c *gin.Context) {
	...
	provisions, err := h.Service.GetAllProvision(body)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *HTTPHandler) UpdateProvision(c *gin.Context) {
	...
	provisions, err := h.Service.UpdateProvision(&body)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *HTTPHandler) DeleteProvision(c *gin.Context) {
	...
	err = h.Service.DeleteProvision(id)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
